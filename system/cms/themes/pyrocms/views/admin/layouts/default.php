...
<body>
	...
	<footer class="clearfix">
		<div class="wrapper">
			<p class="credits">Copyright &copy;<?php echo date('Y'); ?> America Meeting Rooms &nbsp; <span> <?php echo 'Publish Platform' ?> &nbsp; Rendered in {elapsed_time} sec. using {memory_usage}.</span></p>
