        ...
        <div class="tabs">        
            ...
            <div class="form_inputs" id="locations-info-tab">
                ...
                <ul>
                    ...
                    <li>
                        <label for="location_type_id"><?php echo lang('location:type_label');?> <span> *</span></label>
                        <div class="input">
                            <?php echo form_dropdown('location_type_id', array(''=>'') + $dd_array->locations_type, $location->location_type_id,'data-placeholder="'.lang('location:type_select').'" ') ?>                    
                        </div>
                    </li>            
                    <li>
                    ...
                    <ul>    
                        <li class="even">
                            ...
                            <div class="input">
                                ...
                                <?php echo  form_hidden('geo_street_name', $location->geo_street_name , 'id="geo_street_name" '); ?>
                                <?php echo  form_hidden('geo_street_number', $location->geo_street_number , 'id="geo_street_number" '); ?>                            
                            </div>
                        </li>
                        <li class="even">
                        ...
                        <li>
                            ...
                            <div class="input">
                                <?php echo anchor('', lang('location:ws_label'),'id="btn_ws_latlng" class="btn orange"'); ?>                                                                
                ...
                <fieldset>
                    <ul>     
                        ...
                        <li>
                            ...
                            <div class="input">
                                <?php echo form_dropdown('dd_social', $dd_array->social,'','data-placeholder="'.lang('location:social_select_label').'" style="width:150px" id="dd_social"') ?>                                                             
                                <?php echo form_input('user_account','','placeholder="'.lang('location:input_social').'"'); ?>
                                <?php echo anchor('', lang('location:add'),'id="btn_add" class="btn orange"'); ?><br>
