...
class Admin_Countries extends Admin_Controller {
	...
	public function __construct()
	{
		...
		{                
            ...
            {
                $_continents[trim($cont->MapReference)] = trim($cont->MapReference);
            }                    
        }
		//Carga lista de select boxes
		$this->template
			 ->set('continents',$_continents);        
	}
	...
	public function index()
	{
		...
		$this->input->is_ajax_request() ? $this->template->build('admin/tables/countries') : $this->template->build('admin/countries/index');
	...
	public function ajax_filter()
	{
        ...
        //query with limits
        $results = $this->geo_countries_m->limit($pagination['limit'], $pagination['offset'])->search('results',$post_data);
