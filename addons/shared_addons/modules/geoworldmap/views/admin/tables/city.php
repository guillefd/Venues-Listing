<section class="title">
    <h3><?php echo lang('geo_city_title').': '.$city->City; ?> (<?=$city->country ?>)</h3>            
</section>
<section class="item">
    <table class="blue">
		<thead>
		...
		<tbody>
			<tr>
                ...
                <td rowspan="7">
                	<img src="http://maps.google.com/maps/api/staticmap?center=<?=$city->Latitude ?>,<?=$city->Longitude ?>&zoom=9&size=450x200&sensor=false&markers=<?=$city->City ?>"</td>
            </tr>
			<tr>
