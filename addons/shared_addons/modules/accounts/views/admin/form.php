...
<section class="title">
	...
	<h4><?php echo lang('accounts:'.$this->method); ?> : <? echo $account->name; ?></h4>
</section>
                ...
                <fieldset>	
        	        <ul>
                        <li class="<?php echo alternator('', 'even'); ?>">
                                ...
                                <div class="input"><?php echo form_input('name', $account->name, 'class="width-15"'); ?></div>
                        </li>
                        <li class="<?php echo alternator('', 'even'); ?>">
                                <label for="account_type"><?php echo lang('accounts:account_type'); ?> <span>*</span></label>
                                <div class="input"><?php echo form_dropdown('account_type',$account_type_array,set_value('account_type',$account->account_type),'data-placeholder="'.lang('accounts:account_type').'" id="account_type"') ?></div>                                                         
                        </li>                    
                        <li class="<?php echo alternator('', 'even'); ?>">
                                <label for="industry"><?php echo lang('accounts:industry'); ?> <span></span></label>
                                <div class="input"><?php echo form_input('industry', $account->industry, 'class="width-15"'); ?></div>
                        </li>                                                        
        		    </ul>
        		</fieldset>
        	</div>     
                ...
                <fieldset>
                    <ul>
                        <li class="<?php echo alternator('', 'even'); ?>">
                            ...
                            <div class="input">
                                <?php echo form_input('phone_area_code', $account->phone_area_code, 'class="width-15" placeholder="'.lang('accounts:phonecode').'"'); ?>    
                                <?php echo form_input('phone', $account->phone, 'class="width-15" placeholder="'.lang('accounts:phone').'"'); ?>
                                <?php echo form_input('fax', $account->fax, 'class="width-15" placeholder="'.lang('accounts:fax').'"'); ?>
                            </div>
                        </li>
                        <li>
                            <label for="email"><?php echo lang('accounts:email'); ?> <span></span></label>
                            <div class="input">
                                <?php echo form_input('email', $account->email, 'class="width-15" placeholder="'.lang('accounts:email').'"'); ?>
                            </div>
                        </li>                  
                    </ul>
                </fieldset>        
                ...
                <fieldset>
                    <ul>
                        <li class="<?php echo alternator('', 'even'); ?>">
                            ...
                            <div class="input">
                                <?php echo form_input('address_l1', $account->address_l1, 'class="width-15"; placeholder="'.lang('accounts:address_l1').'"'); ?>
                                <?php echo form_input('address_l2', $account->address_l2, 'class="width-15"; placeholder="'.lang('accounts:address_l2').'"'); ?>
                                <?php echo form_input('area', $account->area, 'class="width-15"; placeholder="'.lang('accounts:area').'"'); ?>                                
                            </div>                            
                        </li>
                        <li class="even">
                            <label for="City"><?php echo lang('accounts:cityauto');?> <span>*</span></label>
                            <div class="input">
                                <?php echo  form_input('City', $account->City,'id="CityAjax" style="width:442px" placeholder="'.lang('accounts:city_placeholder').'"'); ?>
                                <?php echo  form_hidden('CityID', $account->CityID,'id="CityID" placeholder="'.lang('accounts:cityid').'"'); ?>                    
                                <?php echo  form_input('zipcode', $account->zipcode,'placeholder="'.lang('accounts:zipcode').'"'); ?>
                            </div>
                        </li>
                        <li>
                        ...
                        <li class="even">
                            ...
                            <div class="input">
                                <?php echo  form_input('Latitude', $account->Latitude,'id="Latitude" placeholder="'.lang('accounts:latitude').'"'); ?>
                                <?php echo  form_input('Longitude', $account->Longitude,'id="Longitude" placeholder="'.lang('accounts:longitude').'"'); ?>                    
                                <?php echo  form_input('latlng_precision', $account->latlng_precision,'id="latlng_precision" readonly="readonly" placeholder="'.lang('accounts:latlng_precision').'"'); ?>
                            </div>
                        </li>
                    </ul>
                </fieldset>
                ...
                <fieldset>
                    <ul>
                        <li class="<?php echo alternator('', 'even'); ?>">
                                ...
                                <div class="input"><?php echo form_input('razon_social', $account->razon_social, 'class="width-15"'); ?></div>
                        </li>                
                        <li class="<?php echo alternator('', 'even'); ?>">
                                <label for="cuit"><?php echo lang('accounts:cuit'); ?> <span></span></label>
                                <div class="input"><?php echo form_input('cuit', $account->cuit, 'class="width-15"'); ?></div>
                        </li> 
                        <li>
                            <label for="iva"><?php echo lang('accounts:iva'); ?> <span></span></label>                                                    
                            <div class="input">
                                <?php echo form_dropdown('iva', $cond_iva_array, $account->iva,'data-placeholder="'.lang('accounts:select_iva').'" id="iva"') ?>                             
                            </div>                    
                        </li>    
                        <li>
                            <label for="iibb"><?php echo lang('accounts:iibb'); ?> <span></span></label>                                                    
                            <div class="input">
                                <?php echo form_input('iibb', $account->iibb, 'class="width-15"'); ?>
                            </div>                    
                        </li>                      
                    </ul>
                </fieldset>
                ...
                <fieldset>
                    <ul>
                        <li class="<?php echo alternator('', 'even'); ?>">
                            ...
                            <div class="input">
                                <?php echo form_input('pago_proveedores_mail', $account->pago_proveedores_mail, 'class="width-15" placeholder="'.lang('accounts:pago_proveedores_mail').'"'); ?>
                                <?php echo form_input('pago_proveedores_tel', $account->pago_proveedores_tel, 'class="width-15" placeholder="'.lang('accounts:pago_proveedores_tel').'"'); ?>
                            </div>                            
                        </li>                 
                        <li>
                            ...
                            <div class="input">                                                        
                                ...
                                <br>
                                <?php echo form_hidden('pago_proveedores_dias_horarios', $account->pago_proveedores_dias_horarios, ''); ?>                                                                                           
                        ...
                        <li>
                            ...
                            <div class="input">                                                        
                                <?php echo form_dropdown('pago_proveedores_forma_de_pago', $forma_de_pago_array, $account->pago_proveedores_forma_de_pago,'data-placeholder="'.lang('accounts:pago_proveedores_forma_de_pago').'" id="pago_proveedores_forma_de_pago" ') ?>
                            </div>  
                        </li>                    
                        <li>
                            <label for="pago_proveedores_detalle"><?php echo lang('accounts:pago_proveedores_detalle'); ?><span></span></label>
                            <div class="input">
                                <?php echo form_textarea('pago_proveedores_detalle', $account->pago_proveedores_detalle, 'class="width-15"'); ?>
                            </div>
                        </li>
                        <li class="<?php echo alternator('', 'even'); ?>">
                            <label for="cuentas_por_cobrar_mail"><?php echo lang('accounts:cuentas_por_cobrar'); ?> <span></span></label>
                            <div class="input">
                                <?php echo form_input('cuentas_por_cobrar_mail', $account->cuentas_por_cobrar_mail, 'class="width-15" placeholder="'.lang('accounts:cuentas_por_cobrar_mail').'"'); ?>
                                <?php echo form_input('cuentas_por_cobrar_tel', $account->cuentas_por_cobrar_tel, 'class="width-15" placeholder="'.lang('accounts:cuentas_por_cobrar_tel').'"'); ?>
                            </div>                            
                        </li>   
                        <li>
                            <label for="cuentas_por_cobrar_detalle"><?php echo lang('accounts:cuentas_por_cobrar_detalle'); ?><span></span></label>
                            <div class="input">
                                <?php echo form_textarea('cuentas_por_cobrar_detalle', $account->cuentas_por_cobrar_detalle, 'class="width-15"'); ?>
                            </div>
                        </li>                    
                    </ul>
                </fieldset>        
