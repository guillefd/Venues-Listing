...
$(document).ready(function() {
	...
	Dropzone.options.imgdropzone = {
		...
		dictInvalidFileType: "Archivos permitidos: jpg, png y gif.", // mensaje error tipo de archivo
		paramName: "userfile", // nombre del campo que contiene el archivo
		acceptedMimeTypes: "image/jpeg, image/png, image/gif", //tipo de archivo permitido
		...
		init: function() 
		{
			this.on("success", function(file, jsonResponse) 
			{
				...
				{
					//guarda ID de la imagen subida
					dzAddFileIdList(jsonResponse.data);
					//genera fila con datos de la imagen
					imageRow = dzGenerateRowImage(jsonResponse.data);
					//inserta fila a tabla
